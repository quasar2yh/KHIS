...
## 🧑‍🤝‍🧑팀원구성
 ...
 - 팀원: 이훈희 - 환자 진료 예약 (CRUD) , 예약가능한 의사조회 , 채팅 기능 , React 개발 , Deepl 번역기 ,Account조회(통합유저정보)
...
[🚀 5분 이슈보드 노션ver 보러가기](https://www.notion.so/5-0d9a013a1224470f98a2b441f1821120)


[🚀 5분 이슈보드 깃허브ver 보러가기](https://github.com/users/quasar2yh/projects/3)
