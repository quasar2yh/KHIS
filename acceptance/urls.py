...
urlpatterns = [path("charge-item/<int:charge_item_id>/", views.ChargeItemDetailAPIView.as_view(), name="charge_item_detail"),
               ...
               path("claim/patient/", views.PatientClaimCreateAPIView.as_view(), name="patient_claim_create_list"),
               path("claim/patient/<int:patient_id>/", views.PatientClaimCreateAPIView.as_view(), name="patient_claim_list"),
