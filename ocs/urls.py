...
urlpatterns = [
    ...
    path('<int:patient_id>/<int:medical_record_id>/',
         views.MedicalRecordAPIView.as_view()),
    path('procedure/', views.ProcedureAPIView.as_view()),
    path('procedure-record/', views.ProcedureRecordAPIView.as_view()),
    path('procedure-record/<int:procedure_record_id>/',
         views.ProcedureRecordAPIView.as_view()),
]
